...
c = ['b', 'r', 'g', 'y']
l = ['Proximity', 'Distance', '1000']
e = ['simple_adversary/maddpg/proximity/03/proxagrewards.pkl', 'simple_adversary/maddpg/vary_lr/001/lragrewards.pkl']
eb = ['simple_adversary/maddpg/proximity/03/proxbenchmark.pkl', 'simple_adversary/maddpg/vary_lr/001/lrbenchmark.pkl']
...
threshold = 0.4
table2 = pd.DataFrame([['maddpg', 'maddpg', l[0]] + success_row([eb[0]], threshold),
                       ['maddpg', 'maddpg', l[1]] + success_row([eb[1]], threshold),
		       ],
