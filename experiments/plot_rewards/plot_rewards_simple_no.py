...
c = ['b', 'r', 'g', 'y']
l = ['3', '4', '5']
e = ['simple_spread/maddpg/vary_lr/001/lragrewards.pkl', 'simple_spread/maddpg/vary_agents/4/lragrewards.pkl', 'simple_spread/maddpg/vary_agents/05/spread_maddpg_maagrewards.pkl']
eb = ['simple_spread/maddpg/vary_lr/001/lrbenchmark.pkl', 'simple_spread/maddpg/vary_agents/4/lrbenchmark.pkl', 'simple_spread/maddpg/vary_agents/05/spread_maddpg_mabenchmark.pkl']
...
table2 = pd.DataFrame([['maddpg', 3] + combine_benchmarks([eb[0]]),
                       ['maddpg', 4] + combine_benchmarks([eb[1]]),
                       ['maddpg', 5] + combine_benchmarks([eb[2]]),
                      ],
